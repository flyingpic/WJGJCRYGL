 ...
 */
public class FPComparePostXmlRetrofitGenerator {
    public static FingerPrintCompareRetrofitInterfaceApi fingerPrintCompareRetrofitInterfaceApi;
...
//                        .header("Content-Type", "text/xml; charset=utf-8")   // 对于SOAP 1.1， 如果是soap1.2 应是Content-Type: application/soap+xml; charset=utf-8
    ...
    public static FingerPrintCompareRetrofitInterfaceApi getWebserviceInterfaceApi() {
        if(fingerPrintCompareRetrofitInterfaceApi == null) {
            fingerPrintCompareRetrofitInterfaceApi = createService(FingerPrintCompareRetrofitInterfaceApi.class);
        }
        return fingerPrintCompareRetrofitInterfaceApi;
    }
}
